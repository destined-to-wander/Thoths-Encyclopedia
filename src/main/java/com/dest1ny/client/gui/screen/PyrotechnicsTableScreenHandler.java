package com.dest1ny.client.gui.screen;

import com.dest1ny.index.ModBlocks;
    ...
    public PyrotechnicsTableScreenHandler(int syncId, PlayerInventory inventory, ScreenHandlerContext context) {
        ...
        this.addSlot(new Slot(this.resultInventory, 20, 141, 62) {
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                NbtCompound fireworkStar = typeSlot.getStack().isOf(Items.FIREWORK_STAR)
                        ? typeSlot.getStack().getOrCreateSubNbt("Explosion")
                        : (new ItemStack(Items.FIREWORK_STAR).getOrCreateSubNbt("Explosion"));
